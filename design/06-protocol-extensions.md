...
| E15 | ✅ **Landed 2026-09-09** as Core v1.2. §1.1–§1.3 admit both identity models; §1.2's properties are requirements on the *result*, which independent generation meets by other means. Harness §5 amended with it | Nothing; conformance rather than function | Landed |
...
**✅ Landed 2026-09-09 as Core v1.2**, and it took one amendment the proposal below had not
asked for. The reference *harness* spec tested the derived mechanism rather than the properties
Core §1.2 requires — so a client generating independent seeds, which this document argues is
conformant, would have been reported as failing by the conformance suite. A specification that
permits two models and a test that permits one are the same defect in two places.
