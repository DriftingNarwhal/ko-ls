...
**Updated:** 2026-08-23 (the design set read against the code, then D31–D35 carried through design → spec → build. O18 is closed; O17, the voided-actions report, is the audit's one remaining gap)
