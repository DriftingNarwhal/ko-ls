...
//!
//! The harness these use lives in `common`, because a third install needs the
//! same one (`three_nodes.rs`).

mod common;
use common::{every_daemon_log, field, ok, patience, run, serve, serve_sealing, serve_tuned, Home};
